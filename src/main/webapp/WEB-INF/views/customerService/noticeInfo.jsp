...
<body>
    ...
    <div class="cnContext">
        <form action="/support/updateNotice" method="post">
            <div class="title-date">
                <input type="text" id="cnTitle" name = noticeTitle value="${noticeInfo.noticeTitle}" readonly>
				<input type="text" id="currentDate" name = noticeRegDate value="${noticeInfo.noticeRegDate}" readonly="readonly" required>
            </div>
            <div>
                <textarea rows="10" cols="30" name="noticeContent" readonly="readonly" required>${noticeInfo.noticeContent}</textarea>
            </div>	
            	<input type="hidden" name="noticeNo" value="${noticeInfo.noticeNo}" />
			<div class="button-container">
				<input type = "button" id="goBack" onclick="window.history.back()" value = "돌아가기">
				<input type = "button" id="updateNotice" value = "수정하기">
				<input type = "button" id="deleteNotice" value = "삭제하기">
			</div>
    ...
    <script type="text/javascript" src="/resources/customerServiceJs/noticeInfo.js"></script>
    <script type="text/javascript" src="/resources/customerServiceJs/menu.js"></script>
    <script type="text/javascript"
		src="/resources/popUpJs/popUpMain.js"></script>
